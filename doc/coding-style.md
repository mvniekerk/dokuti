...
- [Recommended reading](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#recommended-reading)
- [Coding style](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#coding-style)
  - [Formatting](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#formatting)
  - [Field, class, and method declarations](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#field-class-and-method-declarations)
  - [Variable naming](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#variable-naming)
  - [Space pad operators and equals](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#space-pad-operators-and-equals)
  - [Be explicit about operator precedence](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#be-explicit-about-operator-precedence)
  - [Documentation](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#documentation)
  - [Imports](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#imports)
  - [Use annotations wisely](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#use-annotations-wisely)
  - [Use interfaces](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#use-interfaces)
- [Writing testable code](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#writing-testable-code)
  - [Fakes and mocks](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#fakes-and-mocks)
  - [Let your callers construct support objects](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#let-your-callers-construct-support-objects)
  - [Testing multithreaded code](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#testing-multithreaded-code)
  - [Testing antipatterns](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#testing-antipatterns)
- [Avoid randomness in tests](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#avoid-randomness-in-tests)
- [Best practices](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#best-practices)
  - [Defensive programming](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#defensive-programming)
  - [Clean code](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#clean-code)
  - [Use newer/better libraries](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#use-newerbetter-libraries)
  - [equals() and hashCode()](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#equals-and-hashcode)
  - [Premature optimization is the root of all evil](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#premature-optimization-is-the-root-of-all-evil)
  - [TODOs](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#todos)
  - [Obey the Law of Demeter](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#obey-the-law-of-demeter-lod)
  - [Don't Repeat Yourself](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#dont-repeat-yourself-dry)
  - [Manage threads properly](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#manage-threads-properly)
  - [Avoid unnecessary code](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#avoid-unnecessary-code)
  - [The 'fast' implementation](https://github.com/GrindrodBank/dokuti/doc/coding-style.md#the-fast-implementation)
...
*See also [texas imports](#stay-out-of-texas)*
    ...
    // Good.
    import com.dokuti.baz.foo.BazFoo;
    import com.dokuti.Foo;
...
registering with
[ShutdownRegistry](https://github.com/dokuti/commons/blob/master/src/java/com/dokuti/common/application/ShutdownRegistry.java).
